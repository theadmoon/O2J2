...
OPERATIONAL_CHAIN_STAGES = [
    ...
    {"stage_number": 6, "status_key": "delivered", "display_name": "Delivered", "timestamp_field": "delivered_at", "documents": ["certificate_delivery"]},
    {"stage_number": 7, "status_key": "files_accessed", "display_name": "Files Accessed", "timestamp_field": "files_accessed_at", "documents": ["download_confirmation"]},
    ...
    {"stage_number": 10, "status_key": "payment_sent", "display_name": "Payment Sent", "timestamp_field": "payment_marked_by_client_at", "documents": ["payment_instructions", "receipt"]},
