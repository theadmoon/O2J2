...
OPERATIONAL_CHAIN_STAGES = [
    ...
    {"stage_number": 8, "status_key": "delivery_confirmed", "display_name": "Delivery Confirmed", "timestamp_field": "delivery_confirmed_at", "documents": ["acceptance_act"]},
    {"stage_number": 9, "status_key": "work_accepted", "display_name": "Work Accepted", "timestamp_field": "work_accepted_at", "documents": ["payment_instructions"]},
